...
const fieldLayouts = {
  ...
  Campus: [
    ...
    { id: "row-2", fields: ["cityName", "campaignAreaName"] },
    { id: "row-3", fields: ["campusName", "issuedTo"] },
    { id: "row-4", fields: ["availableAppNoFrom", "availableAppNoTo"] },
    { id: "row-5", fields: ["applicationNoFrom", "range"] },
    { id: "row-6", fields: ["applicationNoTo", "issueDate"] },
    { id: "row-7", fields: ["mobileNumber", ""] },
  ],
};
